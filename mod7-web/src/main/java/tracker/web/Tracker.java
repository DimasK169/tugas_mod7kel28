    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!request.getParameter("value").isEmpty()) {
               ...
               array = trackerBean.addArray(Double.parseDouble(request.getParameter("value")));
            } else {
            ...
            if(trackerBean.getCount() != 0){
               ...
               max = trackerBean.getMax(array);
               min = trackerBean.getMin(array);
            } 
           
            out.println("Count: " + count + "<br />");
            out.println("Total: " + total + "<br />");
            out.println("Average: " + average + "<br />");
            out.println("History: " + array + "<br />");
